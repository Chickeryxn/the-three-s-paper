...
def main():
    ...
    claims = [
        ...
        claim("q4_sens_h_m_minus5pct_hours",
              rv["checks"]["h_m_perturbation"]["minus5pct"]["observed"]["t_dry_shift_hours"], "h",
              "robustness/Q4/q4_robustness_summary.json",
              "$.checks.h_m_perturbation.minus5pct.observed.t_dry_shift_hours", D),
        claim("q4_sens_c_inf_low_hours",
              rv["checks"]["env_extrapolation_c_inf_0.045"]["observed"]["t_dry_shift_hours"], "h",
              "robustness/Q4/q4_robustness_summary.json",
              "$.checks.env_extrapolation_c_inf_0.045.observed.t_dry_shift_hours", D),
        claim("q4_sens_c_inf_high_hours",
              rv["checks"]["env_extrapolation_c_inf_0.055"]["observed"]["t_dry_shift_hours"], "h",
              "robustness/Q4/q4_robustness_summary.json",
              "$.checks.env_extrapolation_c_inf_0.055.observed.t_dry_shift_hours", D),
