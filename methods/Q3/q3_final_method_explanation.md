...
> 本文是 Q3 的**权威方法说明**，供论文写作与 solution package 引用。来源：方法卡、决策账本、代码计划、最终结果与稳健性证据。
...
**几何**：半径恒定 R = 2 cm。模型与 Q2 **完全相同**，差别仅在输出口径与结论形态（本问的交付是烘干所需时间）。
...
见 `methods/Q3/q3_decisions.jsonl`。关键项：
